...
const otpStore = {}; // in‑memory OTP store (can be moved to DB if needed)
...
app.post('/user/sync', (req, res) => res.json({ success: true })); // optional
...
app.post('/add-product', async (req, res) => {
    try {
        const newProduct = new Product({
            id: Date.now(), // keep numeric id for compatibility
            name: req.body.name,
